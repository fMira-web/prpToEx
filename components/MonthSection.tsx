...
import { handleActivateKey } from '../lib/a11y';
...
export default function MonthSection({ month }: { month: MonthMeta }) {
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-3.5 px-4 sm:px-5 py-4 cursor-pointer select-none focus-ring"
        role="button"
        tabIndex={0}
        aria-expanded={isOpen}
        onClick={() => toggleMonth(month.month)}
        onKeyDown={(e) => handleActivateKey(e, () => toggleMonth(month.month))}
      >
