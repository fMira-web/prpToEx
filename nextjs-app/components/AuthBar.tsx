...
// Minimal account UI wired to the block-1 auth API (app/api/auth/*). Floats
// over the legacy page rather than living inside the lifted static markup —
// see page.tsx's comment. Deliberately small: this proves the auth wiring
// end-to-end (register/login/me/logout), not a finished account settings
// screen. Block 2 is where DayProgress/ExerciseAttempt actually start
// reading req.user instead of localStorage, which is when a "your progress
// is synced" indicator here would start meaning something.
